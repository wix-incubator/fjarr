...
public class MockHttpServletRequest implements HttpServletRequest
{
    ...
    public MockHttpServletRequest(String method, String body, MultiMap<String, String> headers)
    {
        ...
        headerNamesEnumeration = MockUtils.fromIterator(headers.keySet().iterator());
    ...
    public Enumeration getHeaders(String name)
    {
        ...
        Enumeration<String> headersEnumeration = MockUtils.fromIterator(headers.getAll(name).iterator());

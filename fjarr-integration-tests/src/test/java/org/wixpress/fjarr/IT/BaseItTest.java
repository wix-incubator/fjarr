...
import org.wixpress.fjarr.example.*;
...
public abstract class BaseItTest
{
    ...
    public void testLocalInvocationToString()
    {
        ...
        assertThat(s, Matchers.containsString("RPC Proxy for"));
    }
    ...
    public void testDataStructService()
    {
        ...
        assertThat(ds.getString(), Matchers.is("test with no children"));
        assertThat(ds.getIteger(), Matchers.is(10));
        assertThat(ds.getDbl(), Matchers.is(0.0));
    ...
    public void testInvalidJsonReturnsHttpStatus400() throws Exception
    {
        ...
        {
            assertThat(e.getStatusCode(), Matchers.is(HttpStatus.BAD_REQUEST));
        }
    }
    ...
    public void testDataStructServiceWithMap()
    {
        ...
        assertThat(ds.getString(), Matchers.is("test with children in map"));
        assertThat(ds.getIteger(), Matchers.is(20));
        assertThat(ds.getDbl(), Matchers.is(2.0));
        assertThat(ds.getMap().size(), Matchers.is(10));
    ...
    public void testDataStructServiceWithList()
    {
        ...
        assertThat(ds.getList().size(), Matchers.is(10));
    ...
    public void testDataStructServiceWithSet()
    {
        ...
        assertThat(ds.getSet().size(), Matchers.is(10));
    ...
    public void testDataStructServiceWithAll()
    {
        ...
        assertThat(dses.length, Matchers.is(3));

        assertThat(dses[0].getMap().size(), Matchers.is(10));
        checkChildren(dses[0].getMap());

        assertThat(dses[1].getList().size(), Matchers.is(10));
        checkChildren(dses[1].getList());

        assertThat(dses[2].getSet().size(), Matchers.is(10));
    ...
    public void testCheckedException()
    {
        ...
        {
            assertThat(e.getMessage(), Matchers.is("wrapper"));
    ...
    public void testCheckedComplexException()
    {
        ...
        {
            assertThat(e.getMessage(), Matchers.is("test"));
            assertThat(e.getI(), Matchers.is(10));
    ...
    public void testDescribe() throws Throwable
    {
        ...
        assertThat(response, Matchers.is("org.wixpress.fjarr.example.DataStructService"));
    }
    ...
    private void checkChildren(Map<Integer, DataStructChild> map)
    {
        for (int i = 0; i < 10; i++)
        {
            ...
            assertThat(dsc.getName(), Matchers.is(Integer.toString(i)));
            assertTrue(dsc.getValue() instanceof Integer);
            assertThat((Integer) dsc.getValue(), Matchers.is(i));
        }
    }

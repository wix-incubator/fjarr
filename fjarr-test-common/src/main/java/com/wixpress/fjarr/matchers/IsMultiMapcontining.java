...
public class IsMultiMapcontining<K, V> extends TypeSafeMatcher<ReadOnlyMultiMap<K, V>>
{
    ...
    @Override
    public boolean matchesSafely(ReadOnlyMultiMap<K, V> multiMap)
    {
    ...
    public static <K, V> org.hamcrest.Matcher<ReadOnlyMultiMap<K, V>> hasEntry(org.hamcrest.Matcher<K> keyMatcher, org.hamcrest.Matcher<V> valueMatcher)
    {
        return new IsMultiMapcontining<K, V>(keyMatcher, valueMatcher);
    }

    @org.hamcrest.Factory
    public static <K, V> org.hamcrest.Matcher<ReadOnlyMultiMap<K, V>> hasEntry(K key, V value)
    {
        return new IsMultiMapcontining<K, V>(is(key), is(value));
    }

    @org.hamcrest.Factory
    public static <K, V> org.hamcrest.Matcher<ReadOnlyMultiMap<K, V>> hasKey(org.hamcrest.Matcher<K> keyMatcher)
    {
        return new IsMultiMapcontining<K, V>(keyMatcher,(Matcher<V>)IsAnything.anything());
    }

    @org.hamcrest.Factory
    public static <K, V> org.hamcrest.Matcher<ReadOnlyMultiMap<K, V>> hasKey(K key)
    {
        return new IsMultiMapcontining<K, V>(is(key), (Matcher<V>)IsAnything.anything());
    }

    @org.hamcrest.Factory
    public static <K, V> org.hamcrest.Matcher<ReadOnlyMultiMap<K, V>> hasValue(org.hamcrest.Matcher<V> valueMatcher)
    {
        return new IsMultiMapcontining<K, V>((Matcher<K>)IsAnything.anything(), valueMatcher);
    }

    @org.hamcrest.Factory
    public static <K, V> org.hamcrest.Matcher<ReadOnlyMultiMap<K, V>> hasValue(V value)
    {

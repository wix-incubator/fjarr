 ...
 * Date: 6/5/12
 */
public class HoopoeRpcJacksonModule extends SimpleModule
{
    private static final String MODULE_NAME = HoopoeRpcJacksonModule.class.getName();
    private static final Version MODULE_VERSION = new Version(1, 0, 0, null);

    public HoopoeRpcJacksonModule()
    {
